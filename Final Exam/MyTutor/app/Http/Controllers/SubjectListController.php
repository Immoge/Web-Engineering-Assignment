...
class SubjectListController extends Controller
{
    public function saveSubject(Request $request)
    {
        ...
        $newSubjectList = new Product();
        $newSubjectList->product_name = $request->prname;
        $newSubjectList->product_price = $request->prprice;
        $newSubjectList->product_type = $request->prtype;
        $newSubjectList->product_qty = $request->prqty;
        $newSubjectList->save();
